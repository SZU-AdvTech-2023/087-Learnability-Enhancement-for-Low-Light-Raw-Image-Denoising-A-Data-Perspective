...
TOUPCAM_OPTION_NOFRAME_TIMEOUT        = 0x01       # no frame timeout: 0 => disable, positive value (>= 500) => timeout milliseconds. default: disable
...
TOUPCAM_NOPACKET_TIMEOUT_MIN     = 500      # 500ms
TOUPCAM_NOFRAME_TIMEOUT_MIN      = 500      # 500ms
...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 53.21341.20220828"""
        cls.__initlib()
